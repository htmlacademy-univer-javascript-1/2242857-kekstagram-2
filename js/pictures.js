...
const elementToPicture = new Map();
let pictures = null;
...
export const addPictures = (picturesParameter) => {
  const fragment = document.createDocumentFragment();

  picturesParameter.forEach((picture) => {
...
export const showPictures = debounce((picturesParameter) => {
  clearPictures();
  addPictures(picturesParameter);
}, 500);
